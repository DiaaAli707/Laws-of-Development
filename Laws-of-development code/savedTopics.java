...
public class savedTopics extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        displaySavedTopicsList();
        getSupportActionBar().setTitle("Saved Topics");

    }

    public void displaySavedTopicsList() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                LV.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                    ...
                    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                        ...
                        Intent intent = new Intent(savedTopics.this,displayTopicsFromSelectedTables.class);
